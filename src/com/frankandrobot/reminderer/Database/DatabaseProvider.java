...
public class DatabaseProvider extends ContentProvider {
    ...
    private static String authorityName = "com.frankandrobot.reminderer.dbprovider";
    private SQLiteOpenHelper mOpenHelper;

    // The DB will have tow tables: tasks and gps_tasks
    private static final int TASKS = 1;
    private static final int TASKS_ID = 2;
    private static final int GPS_TASKS = 3;
    private static final int GPS_TASKS_ID = 4;

    private static final UriMatcher sURLMatcher = new UriMatcher(
	    UriMatcher.NO_MATCH);

    static {
	sURLMatcher.addURI(authorityName, "tasks", TASKS);
	...
	case TASKS_ID: // query is for specific task
	    ...
	    break;
	case GPS_TASKS: // query is for all GPS tasks
	    qb.setTables("gps_tasks");
	    break;
	case GPS_TASKS_ID: // query is for specific task
	    qb.setTables("gps_tasks");
	    qb.appendWhere("_id=");
	    qb.appendWhere(url.getPathSegments().get(1));
	    break;
	...
	switch (match) {
	case TASKS:
	    return "vnd.android.cursor.dir/"+authorityName+".tasks";
	case TASKS_ID:
	    return "vnd.android.cursor.item/"+authorityName+".tasks";
	case GPS_TASKS:
	    return "vnd.android.cursor.dir/"+authorityName+".gps_tasks";
	case GPS_TASKS_ID:
	    return "vnd.android.cursor.item/"+authorityName+".gps_tasks";
