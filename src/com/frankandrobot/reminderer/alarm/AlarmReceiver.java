...
public class AlarmReceiver extends BroadcastReceiver
{
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        Task task = null;
        final byte[] data = intent.getByteArrayExtra(AlarmConstants.TASK_RAW_DATA);
        if (data != null)
        {
        ...
        {
            Log.v(TAG,
                  "AlarmReceiver failed to parse the task from the intent");
            return;
        }
        ...
        Log.v(TAG,
              "AlarmReceiver.onReceive() id " + task.getId() + " setFor " + format.format(task.get(Task.Task_Calendar.class).getDate()));
